...
# Study the comments and code provided before doing the exercises.
...
# Hint: you might start by defining something like twoBitAdd but that also has a carry input.
...
def test_fourBitAdd():
    ...
    print("test_fourBitAdd worked 4/4")
